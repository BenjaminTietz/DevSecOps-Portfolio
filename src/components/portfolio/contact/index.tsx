        ...
        <div className={styles.container}>
          ...
          <div className={styles.left}>
            ...
            <p className={styles.text}>
              ...
              projects. I’m always happy to connect and exchange ideas.
            </p>
            ...
            <ul className={styles.list}>
              ...
              <li>
                I’m especially interested in building reliable and secure
                systems for real-world use
              </li>
              <li>
                Open to remote, hybrid, or on-site roles depending on the
                project and setup
              </li>
            </ul>
          </div>
